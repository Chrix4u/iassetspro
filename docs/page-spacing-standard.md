...
- Every active page root is centered, `width: 100%`, and capped at `1600px` so detail, dashboard, list, form, and report pages keep the same left/right rhythm on large displays.
