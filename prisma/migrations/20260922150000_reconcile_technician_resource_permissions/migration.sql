...
VALUES
  (CONCAT('perm_', REPLACE(UUID(), '-', '')), 'tools.view', 'Tools - View', 'tools', 'view', 'View access for Tools module', NOW(3), NOW(3)),
  (CONCAT('perm_', REPLACE(UUID(), '-', '')), 'work_orders.view_own', 'Work Orders - View Own', 'work_orders', 'view_own', 'View Own access for Work Orders module', NOW(3), NOW(3)),
  (CONCAT('perm_', REPLACE(UUID(), '-', '')), 'work_orders.update', 'Work Orders - Update', 'work_orders', 'update', 'Update access for Work Orders module', NOW(3), NOW(3)),
  (CONCAT('perm_', REPLACE(UUID(), '-', '')), 'work_orders.start', 'Work Orders - Start', 'work_orders', 'start', 'Start access for Work Orders module', NOW(3), NOW(3)),
  (CONCAT('perm_', REPLACE(UUID(), '-', '')), 'repair_tool_requests.view_own', 'Repair Tool Requests - View Own', 'repair_tool_requests', 'view_own', 'View Own access for Repair Tool Requests module', NOW(3), NOW(3)),
  (CONCAT('perm_', REPLACE(UUID(), '-', '')), 'repair_tool_requests.create', 'Repair Tool Requests - Create', 'repair_tool_requests', 'create', 'Create access for Repair Tool Requests module', NOW(3), NOW(3)),
