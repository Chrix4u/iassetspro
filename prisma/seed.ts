...
async function seed() {
  ...
  const systemModules = [
    ...
    { code: 'repairs', name: 'Repairs Maintenance', description: 'Corrective and emergency repair workflows, resources, custody, downtime, and completion', isCore: true, version: '2.0.0', licensed: true },
