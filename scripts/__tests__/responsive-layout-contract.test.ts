...
describe('responsive layout contract', () => {
  ...
  it('keeps long material and tool selectors searchable with metadata above the control', () => {
    ...
    expect(workOrderPanels).toContain('selectedTool.plannerRecommended')
    expect(workOrderPanels).toContain('Planner recommendation')
    expect(workOrderPanels).toContain('Available:')
  })
