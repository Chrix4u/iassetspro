 ...
 *
 * Returns only active maintenance technicians who can execute work in the
 * work order's plant. The endpoint is deliberately work-order scoped so the
 * caller cannot use a generic user/worker directory to enumerate people from
 * another plant or outside the execution role.
 */
