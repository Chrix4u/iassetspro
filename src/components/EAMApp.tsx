...
import { PAGE_PERMISSIONS, PAGE_MODULES } from '@/lib/page-access';
...
const PAGE_TITLES: Record<string, string> = {
  ...
  'maintenance-analytics': 'Repairs Analytics',
  'maintenance-calibration': 'PM Calibration',
...
function PageSwitcher({ page }: { page: string }) {
  ...
  const requiredPermsForPage = PAGE_PERMISSIONS[page] ?? (page.startsWith('settings-') ? ['system_settings.view'] : undefined);
  ...
  const requiredModule = PAGE_MODULES[page];
