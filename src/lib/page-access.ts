...
export const PAGE_MODULES: Record<string, string | string[]> = {
  ...
  'maintenance-calibration': ['calibration', 'assets'],
  ...
  'inventory-suppliers': ['inventory', 'vendors'],
  ...
  'analytics-downtime': ['analytics', 'downtime'],
  'analytics-energy': ['analytics', 'energy'],
  'operations-meter-readings': ['meter_readings', 'assets'],
